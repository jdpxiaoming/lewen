	...
	class playTask extends AsyncTask<Void, integer, String> {
		...
		protected void onPreExecute() {
			...
			playINParam.dataListener = new IAV_DataListener() {
				...
				@Override
				public int onData(AV_HANDLE arg0, byte[] arg1, int arg2,
						int arg3, AV_MediaInfo arg4, Object arg5) {
					// TODO Auto-generated method stub
					return 0;
				}
			};
			...
			playINParam.playerEventListener = new IAV_PlayerEventListener() {
				...
				@Override
				public void onResolutionChange(AV_HANDLE arg0, int arg1,
						int arg2) {
					// TODO Auto-generated method stub
				...
				public void onRecordInfo(Object arg0, AV_Time arg1,
						AV_Time arg2, List<RecordInfo> arg3) {
					// TODO Auto-generated method stub
		...
		protected String doInBackground(Void... params) {
			if (MyApplication.log_handle != null) // 登陆成功才能播放
				realPlay = AVNetSDK.AV_RealPlay(MyApplication.log_handle,
						playINParam, playOutParam);
			else {
				return "请先登陆！";
			}
			return null;
		...
		protected void onPostExecute(String result) {
			if (null != result) {
				Tool.showMsg(MyApplication.getInstance()
		...
		public void handleMessage(Message msg) {
			...
			case 1: // 收藏
				if (result != null && result.contains("errdesc")) {
					String tip = result.substring(
							result.indexOf("<errdesc>") + 9,
							result.lastIndexOf("</errdesc>"));
			...
			case 2: // 攒次通道
				try {
					...
					if (null != parise) {
						MyApplication.getInstance().throwTips(
								parise.getErrdesc());
