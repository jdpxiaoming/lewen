...
public class Util {
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = MyApplication.getInstance().getResources().getAssets().open(assetName);
...
//
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager)MyApplication.getInstance().getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
